...
public class DetallesSocioOro extends DetallesSocio implements Serializable {
	 ...
	 */
	public DetallesSocioOro(String idSocio, String nombreSocio, String apellidosSocio, String direccion,
	 ...
	 * @param idSocio Id del socio
	 */
	public DetallesSocioOro(String idSocio) {
		super(idSocio);
		this.categoria = "Oro";
		this.descuento = 20f;
	}
	 ...
	 */
	public DetallesSocioOro(String idSocio, DetallesCliente cliente) {
