...
public class DetallesSocioAdulto extends DetallesSocio implements Serializable {
	 ...
	 */
	public DetallesSocioAdulto(String idSocio, String nombreSocio, String apellidosSocio, String direccion,
	 ...
	 * @param idSocio Id del socio
	 */
	public DetallesSocioAdulto(String idSocio) {
		super(idSocio);
		this.categoria = "Adulto";
		this.descuento = 10f;
	}
	 ...
	 */
	public DetallesSocioAdulto(String idSocio, DetallesCliente cliente) {
